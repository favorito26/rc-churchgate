...
INSERT OR IGNORE INTO users (email, role, status, created_at, updated_at) VALUES
    ('alice.williams@churchgate.test', 'member', 'active', 1785417600, 1785417600),
    ('bob.johnson@churchgate.test',  'member', 'active', 1785417600, 1785417600),
    ('carol.smith@churchgate.test',   'member', 'active', 1785417600, 1785417600),
    ('david.brown@churchgate.test',   'member', 'active', 1785417600, 1785417600),
    ('emma.davis@churchgate.test',    'member', 'active', 1785417600, 1785417600),
    ('frank.miller@churchgate.test',  'member', 'active', 1785417600, 1785417600),
    ('grace.wilson@churchgate.test',  'member', 'active', 1785417600, 1785417600),
    ('henry.taylor@churchgate.test',  'member', 'active', 1785417600, 1785417600),
    ('iris.anderson@churchgate.test', 'member', 'active', 1785417600, 1785417600),
    ('jack.thomas@churchgate.test',   'member', 'active', 1785417600, 1785417600);
...
INSERT OR IGNORE INTO members (
    ...
    (11, 'Jack',    'Thomas',    '(555) 0111', 'male',   684345600, 'Musician',      'Bringing joy through music to the community.',                     1785331200, 1785417600, 1785417600);
